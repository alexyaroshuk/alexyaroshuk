...
**Databases:** PostgreSQL, Firebase, Supabase, IndexedDB
**Frontend:** TypeScript, Next.js, React, Vue.js, Flutter (iOS/Android/Web)
**AI/ML:** YOLO model deployment, ML inference APIs, computer vision pipelines, RAG systems
**DevOps:** Docker, Git, cloud deployment (Render, Vercel, GCP, Digital Ocean)
**AI-Assisted Development:** Claude Code & Cursor - expert in rapid prototyping and AI-accelerated workflows

## 🚀 Featured Projects

### [FastAPI ML Model Management](https://github.com/alexyaroshuk/fastAPIPredict)
...
- **[Live Demo](https://yolo-predict-tester.vercel.app)**
...
### [YOLO8 Converter](https://github.com/alexyaroshuk/YOLO8_converter)
